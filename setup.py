...
class SageTest(TestCommand):
    def run_tests(self):
        errno = os.system("sage -t --force-lib reduce reduce/*.pyx")
        if errno != 0:
            sys.exit(1)
...
if __name__ == "__main__":
    ...
    # Cython modules
    ext_modules = [
             Extension('reduce.one_cython_file',
             sources = [os.path.join('reduce','one_cython_file.pyx')],
    ...
    setup(
        ...
        description='Height reduction of binary forms',
        long_description = readfile("README.rst"), # get the long description from the README
        url='https://github.com/mstreng/reduce',
        author='Marco Streng',
        ...
        keywords = "height, binary form, reduction, discriminant",
