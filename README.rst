===================================================
Height reduction of binary forms
===================================================
.. image:: https://travis-ci.org/mstreng/reduce.svg?branch=master
    :target: https://travis-ci.org/mstreng/reduce
...
Once the Travis CI set-up has been completed, the documentation for the package can be found at https://mstreng.github.io/reduce/doc/html/
...
Download the source from the git repository::
    ...
    $ git clone https://github.com/mstreng/reduce.git
...
Once the package is installed, you can use it in Sage with::
    ...
    sage: from reduce import answer_to_ultimate_question
...
All source code is stored in the folder ``reduce`` using the same name as the
...
[source file](reduce/ultimate_question.py). See also
